        ...
        for(int a=j+1; a<numberofjets-2; a++)
        {
            for(int b=j+2; b<numberofjets-1; b++)
            {
                for(int c=j+3; c<numberofjets; c++)
                {
                    ...
                    {
                        case 0:
                            jets.DelR.push_back(DeltaR[0]);
                            jets.DelR2.push_back(DeltaR[1]);
                            jets.DelRtot.push_back(DeltaR[0] + DeltaR[1]);
                        ...
                        case 1:
                            ...
                            jets.DelRtot.push_back(DeltaR2[0] + DeltaR2[1]);
                            jets.j1.push_back(inputjets[j]);
                        ...
                        case 2:
                            ...
                            jets.DelRtot.push_back(DeltaR3[0] + DeltaR3[1]);
                            jets.j1.push_back(inputjets[j]);
