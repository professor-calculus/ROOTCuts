...
typedef struct {double M_bb, MET, DeltaR, hardDeltaR, NLSPDeltaR, LSPDeltaR, NLSP_PT1, NLSP_PT2, LSP_PT1, LSP_PT2, biaseddeltaphi, HT, MHT; int n_bjets, n_jets, Msq, Mlsp; bool cut_Mbb, cut_DeltaR, cut_biaseddeltaphi, cut_MET, cut_HT, cut_N_bjets, cut_N_jets, cut_MHT;} UNCUT;
